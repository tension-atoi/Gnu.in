...
| 2 | R2: UI Styling Adaptation | Extract styling parameters from `SysterTheme.hpp` and apply them to views (`main_window.py`, `github_panel.py`, etc.) using PySide6 stylesheet syntax. | None | IN_PROGRESS |
